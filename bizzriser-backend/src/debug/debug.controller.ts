        ...
        try {
            ...
            if (counts.pricingPlans === 0) {
                ...
                await this.prisma.pricingPlan.createMany({
                    data: [
                        { name: "Starter", description: "Perfect for small businesses getting started with WhatsApp automation.", price: "49", billingCycle: "monthly", features: JSON.stringify(["1,000 Free Tier Conversations", "Basic Chatbot Builder", "Shared Inbox for 3 Agents", "Standard Analytics", "Email Support"]), recommended: false, order: 0 },
                        { name: "Growth", description: "Our most popular plan for scaling businesses that need advanced automation.", price: "99", billingCycle: "monthly", features: JSON.stringify(["5,000 Free Tier Conversations", "Advanced Chatbot Builder", "Shared Inbox for 10 Agents", "Advanced Analytics & Flow Builder", "Priority Support 24/7", "Basic API Access"]), recommended: true, order: 1 },
                        { name: "Enterprise", description: "Custom solutions for large organizations with complex communication needs.", price: "299", billingCycle: "monthly", features: JSON.stringify(["Unlimited Conversations", "Custom Chatbot Development", "Unlimited Agents", "Custom Reporting", "Dedicated Account Manager", "Full API Access & Webhooks", "Custom System Integrations"]), recommended: false, order: 2 },
                        { name: "Starter", description: "Perfect for small businesses getting started with WhatsApp automation.", price: "39", billingCycle: "yearly", features: JSON.stringify(["1,000 Free Tier Conversations", "Basic Chatbot Builder", "Shared Inbox for 3 Agents", "Standard Analytics", "Email Support"]), recommended: false, order: 0 },
                        { name: "Growth", description: "Our most popular plan for scaling businesses that need advanced automation.", price: "79", billingCycle: "yearly", features: JSON.stringify(["5,000 Free Tier Conversations", "Advanced Chatbot Builder", "Shared Inbox for 10 Agents", "Advanced Analytics & Flow Builder", "Priority Support 24/7", "Basic API Access"]), recommended: true, order: 1 },
