...
export const metadata: Metadata = {
    title: 'GDPR Policy - BizzRiser',
    description: 'GDPR Policy for BizzRiser and bizzriser-api services.',
};
    ...
    return (
        <div className="flex flex-col flex-1 bg-background pt-32 pb-24">
            <div className="container px-4 md:px-6 max-w-4xl mx-auto prose prose-zinc dark:prose-invert">
                <div className="mb-12">
                    <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">GDPR Policy</h1>
                    <p className="text-muted-foreground">Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                </div>

                <section className="space-y-6 text-muted-foreground">
                    <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">What is GDPR?</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Responsibility of Application Admin</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">User’s Responsibility</h2>
                    <p>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Our Action on GDPR</h2>
                    ...
                    <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Supported GDPR Features</h2>
                    
                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Adios, Application</h3>
                    <p>
                        Once you cancel your subscription or delete account we give you option to delete all your data existing or related to your account. Note that, this action is irreversible. The moment you say yes to delete all your data will be erased from the database and server forever. You can back up data before delete in case of re subscribe or re-register.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Secrecy is my right</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">No cookie and session saving</h3>
                    <p>
                        We will give option to save or do not save cookie and session. Even if you save cookie and session these will be destroyed after logout. We strongly suggest you not save your credential in browser. Please memorize your credential or use tools like lastpass to manage your credential.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Destroy footprints</h3>
                    <p>
                        We do not save or track any of your activity for any commercial purpose. We may store your login time or IP for security purpose only. When you delete your account every single piece of your data will be deleted from server.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Social engineering is bad</h3>
                    <p>
                        We do not record any of your personal activity on the application. Recording user’s personal activity, analyzing it and try to sell a product or motivating user to pursue a certain thought upon analyzed data is becoming a malpractice. We do not do such things.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Notify me</h3>
                    <p>
                        Get notified about all your activity relating to your account (account creation, password change) by email. We suggest you to change your credential if any unusual things occur.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Policy Update notification</h3>
                    <p>
                        You will get notified on any privacy policy or disclaimer updates. Read your email regarding to this matter and decide your action. Feel free to consult on this matter.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Connect without worry</h3>
                    <p>
                        We enforced HTTPS everywhere. Data sniffing is not possible on this case. Even possible, the sniffer will get encrypted hash. So feel safe to use our application.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">No data collecting</h3>
                    <p>
                        We do not collect any data of user. No backdoor, No hidden option to collect data. Once the application is uploaded to server even we cannot enter to application without app admin password. So do not worry about any hidden data leak.
                    </p>

                    <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Data breach policy</h3>
                    <p>
                        We implement all the security to store your data carefully on database (data encryption, MySQLi, SQL injection prevention, input checking etc.). But we do not take any responsibility of data breaches from server. Because it is total responsibility of app admin and server admin to secure your data from breaching. Any weak or too predictable password of app admin or server admin could compromise database. Any inherent fault on database config can give away the database. Any security flaw on server can lead to data leaking. Please contact your app admin on this regard.
                    </p>
                </section>
            </div>
        </div>
